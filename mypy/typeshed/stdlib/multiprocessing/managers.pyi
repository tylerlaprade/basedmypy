...
class BaseListProxy(BaseProxy, MutableSequence[_T]):
    ...
    def pop(self, __index: SupportsIndex = ...) -> _T: ...  # type: ignore[override]
    def index(self, __value: _T, __start: SupportsIndex = ..., __stop: SupportsIndex = ...) -> int: ...  # type: ignore[override]
