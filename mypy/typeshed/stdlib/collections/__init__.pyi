...
class UserList(MutableSequence[_T]):
    ...
    def index(self, item: _T, __start: SupportsIndex = 0, __stop: SupportsIndex = sys.maxsize) -> int: ...  # type: ignore[override]
...
class deque(MutableSequence[_T], Generic[_T]):
    ...
    def append(self, __x: _T) -> None: ...  # type: ignore[override]
    def appendleft(self, __x: _T) -> None: ...
    def copy(self) -> Self: ...
    def count(self, __x: _T) -> int: ...  # type: ignore[override]
    def extend(self, __iterable: Iterable[_T]) -> None: ...  # type: ignore[override]
    def extendleft(self, __iterable: Iterable[_T]) -> None: ...
    def insert(self, __i: int, __x: _T) -> None: ...  # type: ignore[override]
    def index(self, __x: _T, __start: int = 0, __stop: int = ...) -> int: ...  # type: ignore[override]
